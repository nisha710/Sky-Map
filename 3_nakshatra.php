...
$sql = "SELECT * FROM nakshatra WHERE N_name LIKE '%$Name%'";
...
<meta charset="UTF-8">
    ...
    * {
    ...
    body {
        ...
        background-image: url("https://thumbs.gfycat.com/AthleticSerpentineArthropods-size_restricted.gif"); 
    ...
    .image-content {
        ...
        width: 60vmin;
        height: 100%;
        background-image: url("https://images.ganeshaspeaks.com/gsv8/nakshatra/nakshatra-overview.webp");
        /* background-image: url("https://assets.codepen.io/4787486/trees.png"); https://images.ganeshaspeaks.com/gsv8/nakshatra/nakshatra-overview.webp
...
<div class="overlay">
    ...
    <div class="text">
        ...
        echo "<strong>extent:</strong> " . $row["extent_degrees"]."deg";
...
<?php
// echo "<h2>" . $row["N_name"] . "</h2>";
// echo "<strong>extent:</strong> " . $row["extent"] ;
